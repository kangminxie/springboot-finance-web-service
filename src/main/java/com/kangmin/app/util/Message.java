...
public final class Message {
    ...
    public static final String ALREADY_LOGGED_IN = "You are already logged in. Please logout first to switch account.";
    ...
    public static final String BUY_FUND_SUCCESS = "The fund (symbol: %s) has been successfully purchased with $ %s.";
    public static final String SELL_FUND_SUCCESS = "The requested shares (%s) have been successfully sold for fund (symbol: %s).";
